...
class AgencyTest(private val mockMvc: MockMvc, private val objectMapper: ObjectMapper) : FeatureSpec() {
    ...
    private fun getPropertyBase(): Set<PropertyBaseItem> =
        mockMvc.get("/property/base").readResponse()
    ...
    private val propertyBase = setOf(
        Property("г. Рыбное, ул. Новоселов, 13, 45", 50),
        Property("г. Москва, ул. Ленина, 45, 119", 100)
    )


    private val propertyPrices = mapOf(
        "г. Рыбное, ул. Новоселов, 13, 45" to 1000000,
        "г. Москва, ул. Ленина, 45, 119" to 5000000
    )
}